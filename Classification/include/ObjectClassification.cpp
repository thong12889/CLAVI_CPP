...
void ObjectClassification::UseCUDA(){
...
void ObjectClassification::UseCPU(){
        std::cout << "Inference Execution Provider: CPU" << std::endl;
        this->session_options.SetIntraOpNumThreads(1);
        this->session_options.SetGraphOptimizationLevel(GraphOptimizationLevel::ORT_ENABLE_ALL);
}

Ort::Session ObjectClassification::SessionInit()
                {
...
void ObjectClassification::Inference(cv::Mat &preprocessedImage)
{
...
void ObjectClassification::DrawResult(cv::Mat &image){
